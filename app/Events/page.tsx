...
export default function events() {
    const events = [
        {
            path: '/kcorner', value: 'K Corner', img: require('./kcorner.png'), Technical: true,
        ...
        { path: '/softwaredebugging', value: 'Software Debugging', img: require('./bug.png'), Technical: true,
        ...
        { path: '/paperpresentation', value: 'Paper Presentation', img: require('./paperpresentation.jpg'), Technical: true,
            edesc: "Team can have maximum of 2 Participants.Certificates will be provided for all participants.First and second prizes are awarded based on judgment",
        ...
        { path: '/posterpresentation', value: 'Poster Presentation', img: require('./posterpresentation.png'), Technical: true,
            edesc:"Team can have maximum of 2 Participants.Certificates will be provided for all participants.First and second prizes are awarded based on judgment",
        ...
        { path: '/groupdiscussion', value: 'Group Discussion', img: require('./gd.jpg'), Non_Technical: true,
            edesc:"",
            erules:"",
         },
        { path: '/mockinterview', value: 'Mock Interview', img: require('./mi.jpg'), Non_Technical: true,   
        ...
        { path: '/quiz', value: 'Quiz', img: require('./quiz.jpg'), Non_Technical: true,
            edesc: "Team can have maximum of 2 Participants.Certificates will be provided for all participants.First and second prizes are awarded based on judgment",
        ...
        { path: '/shortfilm', value: 'Short Film', img: require('./shortfilm.jpg'), Non_Technical: true,
            ...
            {events.map((item, idx) => (
                <Card key={idx} className="card-grid">
                    ...
                    <CardFooter>
                            ...
                            <DialogTrigger asChild>
                                ...
                                <DialogContent className="sm:max-w-800" id="dialog">
                                    <DialogHeader>
                                        ...
                                        <DialogDescription>{item.value}</DialogDescription>
                                    </DialogHeader>
                                    <Separator />
                                    <div className="grid gap-2 py-2">
                                        <div className="grid grid-items-center gap-4">
                                            ...
                                            <DialogTitle>Event Rules :</DialogTitle>
                                            <Separator />
                                            <div className="text-size-small text-black space-y-2 overflow-y-auto max-h-[200px]">
                        ...
                        <div id="tags">
                            <Button variant="outline"><Tag />{item.Technical ? (
                                <p>Technical Event</p>
                            ) : item.Non_Technical && <p>Non-Technical Event</p>}</Button>
                        </div>
                    </CardFooter>
